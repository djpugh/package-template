...
latex_documents = [
  ('latex', '{{cookiecutter.project_slug}}.tex', u'{{cookiecutter.project_slug}}',
...
man_pages = [
    ('man', '{{cookiecutter.project_slug}}', u'{{cookiecutter.project_slug}}',
     [ __author__], 1)]
...
texinfo_documents = [
  ('index', '{{cookiecutter.project_slug}}', u'{{cookiecutter.project_slug}}',
    __author__, '{{cookiecutter.project_slug}}', '{{cookiecutter.description}}',
   'Miscellaneous'),
]
...
epub_title = u'{{cookiecutter.project_slug}}'
epub_author = __author__
epub_publisher = __author__
epub_copyright = copyright

# The basename for the epub file. It defaults to the project name.
#epub_basename = u'{{cookiecutter.project_slug}}'
